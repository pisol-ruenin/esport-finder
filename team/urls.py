...
urlpatterns = [
    ...
    path('team_recruitment_list/',views.team_recruitment_list.as_view(),name='team_recruitment_list'),
    path('team_recruitment_list/<int:pk>/',views.team_recruitment.as_view(),name='team_recruitment'),
